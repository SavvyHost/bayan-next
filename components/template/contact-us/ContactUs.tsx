    ...
    <div className='Contact-us-style '>
      <div className='container my-[70px] lg:my-[100px] flex w-full lg:gap-36 gap-20 lg:px-[80px] flex-col md:!flex-row'>
        ...
        <div className='lg:p-[40px] p-[20px] custom-box-shadow bg-white rounded-[8px] w-full order-2 md:order-1'>
          ...
          <h4 className='text-[#1E1E1E] text-[22px] font-[TajawalMedium,sans-serif]'>
            المقر الرئيسي
          </h4>
          ...
          <div className='my-[24px] flex flex-col gap-[8px]'>
            <h5 className='text-main text-[19px] font-[TajawalMedium,sans-serif]'>
              هاتف:{' '}
          ...
          <div className='flex flex-col gap-[18px]'>
            <h6 className='text-[#1e1e1e] text-[20px] font-[TajawalBold,sans-serif]'>
              ابقي علي تواصل
            </h6>
            ...
            <form className=' lg:w-[85%] flex flex-col gap-[20px]'>
              ...
              <button
                type='submit'
                className='bg-primary text-[20px] text-white h-[44px] rounded-[4px] hover:bg-secondary font-[TajawalBold,sans-serif]'
              >
                إرسال
              </button>
            </form>
        ...
        <div className='w-full md:order-2'>
          <h3 className='lg:text-[48px] text-[35px] font-[TajawalBold,sans-serif] text-primary'>
            تواصل معنا
          </h3>

          <p className='lg:mt-[40px] mt-[20px] text-main font-[TajawalMedium,sans-serif] lg:text-[19px] text-[16px]'>
