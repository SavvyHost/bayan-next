    ...
    <div className='my-[35px] about-me-section'>
      <div className='container my-16'>
        <div className='flex flex-col items-center'>
          <h3 className='text-[29px] lg:text-[34px] text-[#EFBB43] font-[TajawalBold,sans-serif]'>
            ماذا عننا؟
          </h3>
        ...
        <div className='flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-20 mt-[40px]'>
          <div className='flex flex-col items-center'>
            ...
            <p className='text-white text-[15px] lg:text-[16px] xs:w-[60%] sm:!w-[90%] text-center font-[TajawalMedium,sans-serif]'>
