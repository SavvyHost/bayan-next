  ...
  return (
    <div className='container my-[35px] '>
      <div className='flex flex-col items-center'>
        ...
        <p className='text-main text-[15px] lg:text-[17px] text-center'>
      ...
      <div className='flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-20 mt-[40px]'>
        <div className='flex flex-col items-center'>
          <AboutusIcon1 />
          <h4 className='text-[18px] lg:text-[22px] text-secondary mt-[10px] font-[TajawalMedium,sans-serif]'>
            تحفيظ القرءان
          </h4>
          <p className='text-textGray text-[15px] lg:text-[16px] xs:w-[60%] sm:!w-[90%] text-center font-[TajawalMedium,sans-serif]'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-textGray text-[15px] lg:text-[16px] xs:w-[60%] sm:!w-[90%] text-center font-[TajawalMedium,sans-serif]'>
            إختيار الوقت المناسب للأم مع معلمات متخصصات وبرضو تفسير وشرح للآيات
          </p>
        </div>
        <div className='flex flex-col items-center'>
          <AboutusIcon3 />
          ...
          <p className='text-textGray text-[15px] lg:text-[16px] xs:w-[60%] sm:!w-[90%] text-center font-[TajawalMedium,sans-serif]'>
            الأهتمام بشكل فردي لكل طفل مع معلم خاص بيه عشان نضمن الاستفادة وعدم
            التشتت
          </p>
        </div>
        <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-textGray text-[15px] lg:text-[16px] xs:w-[60%] sm:!w-[90%] text-center font-[TajawalMedium,sans-serif]'>
            وتشجيعهم على التحلي بالاخلاق اللي ذكرها القرآن يعني دور تربوي مش بس
            تعليمي
          </p>
        </div>
      </div>
